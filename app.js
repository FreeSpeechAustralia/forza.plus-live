...
const ROUTES = {
  ...
  '/watch': {
    ...
    scriptPath: '/watch.js?v=20260411-rumble-embed-id',
  },
  '/posts': {
    key: 'posts',
    path: '/posts',
  ...
  '/accounts': {
    ...
    fragmentPath: '/fragments/accounts.html?v=20260512-membership-fullprice',
    mainClass: 'accounts-main',
    scriptPath: '/accounts.js?v=20260512-membership-fullprice',
  },
};
